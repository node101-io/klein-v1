...
const OverviewCard = ({
    ...
    const getProgressBarColor = () => {
        return colorMap[color]?.bg || 'bg-gray-500';
    };
    ...
    return (
        <div className="bg-white rounded-[24px] p-6 flex flex-col justify-between">
            <div className='space-y-2'>
                ...
                <div className="flex items-center gap-2 pb-1">
                    ...
                    {warning && (
                        <Image src={WarningIcon} alt="Warning Icon" width={20} height={20} className="text-[#FF1F1F]" />
                    )}
                </div>
            ...
            {type === 'default' ? (
                <div className="w-full h-[10px] rounded-full overflow-hidden" style={{ backgroundColor: '#D9D9D9' }}>
                    <div
                ...
                <div className=''>
                    <SyncStatusIndicator total={syncStatus.total} current={syncStatus.current} />
                </div>
